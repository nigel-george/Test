...
@InputType()
class UserFavoriteRestaurantUpdateManyWithoutRestaurantsInput {
...
export { UserFavoriteRestaurantUpdateManyWithoutRestaurantsInput as UserFavoriteRestaurantUpdateManyWithoutRestaurantsInput };
