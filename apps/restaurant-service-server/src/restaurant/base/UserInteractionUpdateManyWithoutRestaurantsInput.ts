...
@InputType()
class UserInteractionUpdateManyWithoutRestaurantsInput {
...
export { UserInteractionUpdateManyWithoutRestaurantsInput as UserInteractionUpdateManyWithoutRestaurantsInput };
