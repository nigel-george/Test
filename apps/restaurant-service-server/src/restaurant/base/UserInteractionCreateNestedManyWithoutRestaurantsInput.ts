...
@InputType()
class UserInteractionCreateNestedManyWithoutRestaurantsInput {
...
export { UserInteractionCreateNestedManyWithoutRestaurantsInput as UserInteractionCreateNestedManyWithoutRestaurantsInput };
