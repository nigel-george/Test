...
@InputType()
class UserInteractionCreateNestedManyWithoutUsersInput {
...
export { UserInteractionCreateNestedManyWithoutUsersInput as UserInteractionCreateNestedManyWithoutUsersInput };
