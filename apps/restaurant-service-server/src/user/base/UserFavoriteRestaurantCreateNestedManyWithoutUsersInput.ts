...
@InputType()
class UserFavoriteRestaurantCreateNestedManyWithoutUsersInput {
...
export { UserFavoriteRestaurantCreateNestedManyWithoutUsersInput as UserFavoriteRestaurantCreateNestedManyWithoutUsersInput };
